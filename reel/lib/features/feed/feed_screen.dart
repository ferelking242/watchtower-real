...
class FeedScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Erreur → SnackBar flottant, jamais de page d'erreur plein écran
    ref.listen<AsyncValue<List<FeedItem>>>(feedItemsProvider, (_, next) {
    ...
    return Scaffold(
      ...
      body: feedAsync.when(
        ...
        error:   (_, __) => const _FeedSkeleton(),   // shimmer, pas de page d'erreur
        data: (items) {
          if (items.isEmpty) {
...
// ─────────────────────────────────────────────────────────────────────────────
// Shimmer skeleton TikTok-style (remplace l'écran noir de chargement)
// ─────────────────────────────────────────────────────────────────────────────
    ...
    return Skeletonizer(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Overlay bas : infos auteur + sidebar
          Positioned(
            bottom: 72,
            left: 0,
            right: 0,
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  // ── Colonne gauche : auteur + titre + hashtags + son ──────
                  Expanded(
                    child: Column(
