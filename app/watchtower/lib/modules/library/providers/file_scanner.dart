...
/// Scans `Watchtower/local` folder (if exists) for Mangas/Animes and imports in library.
///
/// **Folder structure:**
/// ```
/// Watchtower/local/MangaName/CustomCover.jpg (optional)
/// Watchtower/local/MangaName/Chapter1/Page1.jpg
/// Watchtower/local/MangaName/Chapter2.cbz
/// Watchtower/local/AnimeName/Episode1.mp4
/// Watchtower/local/NovelName/NovelName.epub
/// ```
...
/// Finds the String 'Watchtower/local' and extract path after
/// ```
/// "C:\Users\user\Documents\Watchtower\local\Manga 1\chapter1.zip"
/// becomes:
...
String _getRelativePath(dynamic dir) {
  ...
  int index = relativePath.indexOf("Watchtower/local");
  if (index != -1) {
    return relativePath.substring(index + "Watchtower/local/".length);
  } else {
    return relativePath;
  }
}
