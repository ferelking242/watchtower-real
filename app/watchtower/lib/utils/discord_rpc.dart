...
class DiscordRPC {
  ...
  final RpcActivity activity = RpcActivity(
    assets: const RPCAssets(largeImage: "app-icon", largeText: "Watchtower"),
    buttons: [
      const RPCButton(
        label: "Get Watchtower",
    ...
    await updateActivity(
      ...
      assets:
          ...
          ? RPCAssets(
              ...
              smallImage: "app-icon",
              smallText: "Watchtower",
            )
          : const RPCAssets(largeImage: "app-icon", largeText: "Watchtower"),
    );
  }
